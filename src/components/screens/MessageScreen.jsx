...
export default function MessageScreen() {
    ...
    const romanticMessage = `My Dearest Sendly,

Every day with you feels like a beautiful nightmare that I never want to wake up from. You've brought so much joy, laughter, and warmth into my life that I can't imagine a world without you in it.
...
Happy Anniversary, my beautiful Mental patient. Here's to many more years of love, laughter, and endless happiness together.
